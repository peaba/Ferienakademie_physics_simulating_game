...
const std::unordered_map<Event, ButtonEvent> KEYBOARD_KEY_MAP{
    ...
    {ITEM_PICK, {DEVICE_KEYBOARD, KEY_Q, PRESSED}},
    {ITEM_USE, {DEVICE_KEYBOARD, KEY_E, PRESSED}},
    {ITEM_DROP, {DEVICE_KEYBOARD, KEY_F, PRESSED}},
    {SPECIAL_ABILITY, {DEVICE_KEYBOARD, KEY_R, PRESSED}},
    {FULLSCREEN, {DEVICE_KEYBOARD, KEY_F11, PRESSED}},
    {TOGGLE_DEBUG, {DEVICE_KEYBOARD, KEY_P, PRESSED}},
    {PAUSE, {DEVICE_KEYBOARD, KEY_BACKSPACE, PRESSED}}};

const std::unordered_map<Event, ButtonEvent> GAMEPAD_KEY_MAP{
    {JUMP, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_FACE_DOWN, PRESSED}}, //A
    {DUCK, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_TRIGGER_1, DOWN}}, //R1
    {ITEM_PICK, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_FACE_RIGHT, PRESSED}}, //B
    {ITEM_USE, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_FACE_LEFT, PRESSED}}, //X
    {ITEM_DROP, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_FACE_UP, PRESSED}}, //Y
    {SPECIAL_ABILITY, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_RIGHT_TRIGGER_2, PRESSED}}, //R2
    {PAUSE, {DEVICE_GAMEPAD, GAMEPAD_BUTTON_MIDDLE_RIGHT, PRESSED}}, //START
};
...
const std::unordered_map<Axis, std::list<VirtualAxis>> VIRTUAL_AXIS_MAP{
    {
        ITEM_SWITCH,
        {{{DEVICE_KEYBOARD, KEY_TAB, PRESSED},
          {DEVICE_DISABLED, KEY_N, PRESSED}}},
    },
    {MOVEMENT_X,
     {
