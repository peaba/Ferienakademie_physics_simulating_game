...
RAYGUIAPI int GuiSlider(Rectangle bounds, const char *textLeft, double textRight,
          double value, float minValue, float maxValue); // Slider control, returns selected value
